...
class DDPG(object):
    ...
    def save_models(self, episode_count):
        ...
        torch.save(self.actor_target.state_dict(), '_actor.pkl')
        torch.save(self.critic_target.state_dict(), '_critic.pkl')
        print('Models saved successfully')

    def load_models(self, episode):

        self.actor.load_state_dict(torch.load('_actor.pkl'))
        self.critic.load_state_dict(torch.load('_critic.pkl'))
