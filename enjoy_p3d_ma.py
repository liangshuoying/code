...
print('obs_filter.count', actor_critic.obs_filter.count)
print('obs_filter.sum', actor_critic.obs_filter.sum)
print('obs_filter.mean', actor_critic.obs_filter.mean)
print('obs_filter.std', actor_critic.obs_filter.std)
...
while True:
    ...
    # Clip End
    # multi agent hack
    cpu_actions = np.hstack( (cpu_actions, cpu_actions) )
    # multi agent end
